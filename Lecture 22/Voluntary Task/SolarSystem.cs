...
namespace SpaceSim {
    ...
    public class SolarSystem {
        ...
        private void InitChildren() {
            ...
            Sun.Children.First(p => p.Name.Equals("Earth"))?.AddChildren(
            [
                new Moon("Moon") {OrbitalPeriod = 27.32, OrbitalRadius = 384, Color = 0x808080}
            ]);

            Sun.Children.First(p => p.Name.Equals("Mars"))?.AddChildren(
            [
            ...
            Sun.Children.First(p => p.Name.Equals("Jupiter"))?.AddChildren(
            [
            ...
            Sun.Children.First(p => p.Name.Equals("Saturn"))?.AddChildren(
            [
            ...
            Sun.Children.First(p => p.Name.Equals("Uranus"))?.AddChildren(
            [
            ...
            Sun.Children.First(p => p.Name.Equals("Neptune"))?.AddChildren(
            [
            ...
            Sun.Children.First(p => p.Name.Equals("Pluto"))?.AddChildren(
            [

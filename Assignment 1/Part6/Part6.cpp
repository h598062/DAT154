// Part6.cpp : Defines the entry point for the application.
//
                      ...
                      _In_ int nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_PART6, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PART6));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PART6));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_PART6);
	...
	case WM_KEYDOWN:
		{
			...
			{
			case VK_LEFT:
				intensity_pw = intensity_pw - 10 > 0 ? intensity_pw - 10 : 0;
				break;
			case VK_RIGHT:
				intensity_pw = intensity_pw + 10 < 100 ? intensity_pw + 10 : 100;
				break;
			case VK_UP:
				intensity_pn = intensity_pn + 10 < 100 ? intensity_pn + 10 : 100;
				break;
			case VK_DOWN:
				intensity_pn = intensity_pn - 10 > 0 ? intensity_pn - 10 : 0;
				break;
			default:
				break;
			}

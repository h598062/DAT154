...
public partial class Dat154Context : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("data source=dat154.hvl.no,1443;initial catalog=dat154;persist security info=True;user id=dat154_rw;password=dat154_rw;Encrypt=False");
